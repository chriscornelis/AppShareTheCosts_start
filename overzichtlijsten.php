	...
	<div data-role="content">
		...
		<ul data-role="listview" data-split-icon="delete" data-split-theme="d">
		    ...
		    <li><a href="#">
		       ...
		       <h3>Trip to Paris</h3>
		        <p>Chris Cornelis</p></a>
		        <a href="#deletelist" data-rel="popup" data-position-to="window" data-transition="pop">Verwijder uitgavelijst</a>
		    </li>
		    <li><a href="#">
		...
		<div data-role="popup" id="delete_list" data-theme="d" data-verlay-theme="b" class="ui-content">
			<p>Deze lijst verwijderen uit jouw uitgavenlijsten?</p>
			<a href="#" data-role="button" data-rel="back" data-theme="b" data-inline="true" data-mini="true">Ja, verwijder</a>
